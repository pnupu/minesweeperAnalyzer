...
// Make BruteForceAnalysis and related classes available as globals
if (typeof window !== 'undefined') {
  window.BruteForceAnalysis = BruteForceAnalysis;
  window.BruteForceGlobal = BruteForceGlobal;
  window.SolutionTable = SolutionTable;
  window.Position = Position;
  window.LivingLocation = LivingLocation;
  window.Node = Node;
}